...
from ..infrastructure.database import database, RequestLogModel
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "http://100.64.5.96:5173", "http://100.64.5.96"],
